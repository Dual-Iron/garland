...
static public class Upnp
{
    ...
    static string Port = "";
    static bool Gateway;
    static List<string> maplayout = new();
    static readonly List<string> ServiceTypes = new();
    static readonly List<string> ControlTypes = new();
